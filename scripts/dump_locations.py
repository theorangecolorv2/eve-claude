"""
Дамп локаций (букмарков) из UI дерева.
"""
import sys
import os
import json
...
def main():
    logger.info("=== ДАМП ЛОКАЦИЙ (БУКМАРКОВ) ===")
    ...
    try:
        # Получаем состояние
        logger.info("Получение UI дерева...")
        ...
        if state.bookmarks:
            ...
            results_path = f"temp/bookmarks_dump_{timestamp}.json"
